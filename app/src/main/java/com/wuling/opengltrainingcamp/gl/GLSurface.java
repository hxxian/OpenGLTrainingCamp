...
public class GLSurface {
     ...
     * context somewhere, the createProgram call will fail with complaints from the Surface
     * about already being connected.
     */
    public void recreate(GLCore newEglCore) throws Exception {
        if (mSurface == null) {
//            throw new RuntimeException("not yet implemented for SurfaceTexture");
            Log.e(TAG, "not yet implemented for SurfaceTexture");
            return;
        }
        mEglCore = newEglCore;          // switch to new context
        createWindowSurface(mSurface);  // createProgram new surface
    }
}
